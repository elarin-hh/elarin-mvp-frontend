 ...
 */
function getLeftLegLandmarks(landmarks) {
    return {
 ...
 */
function getRightLegLandmarks(landmarks) {
    return {
 ...
 */
function getLeftArmLandmarks(landmarks) {
    return {
 ...
 */
function getRightArmLandmarks(landmarks) {
    return {
 ...
 */
function getCoreLandmarks(landmarks) {
    return {
...
if (typeof window !== 'undefined') {
    window.MEDIAPIPE_LANDMARKS = MEDIAPIPE_LANDMARKS;
    window.LANDMARK_GROUPS = LANDMARK_GROUPS;
    window.BILATERAL_PAIRS = BILATERAL_PAIRS;
    window.getLeftLegLandmarks = getLeftLegLandmarks;
    window.getRightLegLandmarks = getRightLegLandmarks;
    window.getLeftArmLandmarks = getLeftArmLandmarks;
    window.getRightArmLandmarks = getRightArmLandmarks;
    window.getCoreLandmarks = getCoreLandmarks;
}
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = {
        ...
        BILATERAL_PAIRS,
        getLeftLegLandmarks,
        getRightLegLandmarks,
        getLeftArmLandmarks,
        getRightArmLandmarks,
        getCoreLandmarks
    };
}
